...
public class Exp3 {
	...
	*/
    ...
    public void findClusters(){
        ...
        for(Point3D P : DB) {
            ...
            List<Point3D> N = NN.rangeQuery(P,epsilon); /* Find neighbors */
            ...
            while (!S.empty()) { 
                ...
                N = NN.rangeQuery(Q,epsilon); /* Find neighbors */
                if (N.size() >= minpts) { /* Density check */
	...
	*/
    ...
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        System.out.println("Average Execution time_KD method : "+ (endTime-startTime)/1000+ " s");
    }
}
